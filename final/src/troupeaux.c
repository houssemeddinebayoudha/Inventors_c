...
store=gtk_list_store_new (TROU, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING);
...
gtk_list_store_set (store,&iter,EIDD, a.id,ETYPEE, a.type ,ESEXEE,a.sexe,EDATEE,date,-1);
}
